    ...
    <div className="space-y-2">
      <div className="relative">
        <button
          ...
          className={btnClass}
          style={{ background: '#F5F4F2', borderColor: '#E0DFDD', color: '#1A1918' }}
        >
      ...
      <div className="relative">
        <button
          ...
          className={btnClass}
          style={{ background: 'white', borderColor: '#E0DFDD', color: '#5C5A55' }}
        >
        ...
        {showTooltip === 'sso' && (
          <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 px-3 py-2 rounded-lg text-xs whitespace-nowrap z-10"
