import { MapPin, Calendar, DollarSign, User, Clock, FileText } from 'lucide-react';
...
export function DealDetailDrawer() {
  ...
  return (
    <SideDrawer
      open={isDetailDrawerOpen && !!selectedDealId}
      onClose={closeDetailDrawer}
      title={isLoading ? 'Loading…' : deal?.name ?? 'Deal Details'}
    >
      {isLoading || !deal ? (
