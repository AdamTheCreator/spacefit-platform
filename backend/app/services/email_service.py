                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 480px; background-color: #111111; border: 1px solid #222222;">
                    ...
                    <tr>
                        <td style="padding: 32px 32px 24px; border-bottom: 1px solid #222222;">
                            <span style="font-size: 20px; font-weight: 600; color: #ffffff; letter-spacing: -0.5px;">SpaceFit</span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 32px;">
                            ...
                            <p style="margin: 0 0 24px; font-size: 15px; line-height: 1.6; color: #888888;">
                                Hi {name}, welcome to SpaceFit! Click the button below to verify your email address and get started.
                            </p>
                    ...
                    <tr>
                        <td style="padding: 24px 32px; border-top: 1px solid #222222;">
                            <p style="margin: 0; font-size: 12px; color: #666666;">
                                &copy; SpaceFit AI. All rights reserved.
                            </p>
                        </td>
                    </tr>
                </table>
        ...
        async with httpx.AsyncClient(timeout=10.0) as client:
            response = await client.post(
                ...
                json={
                    ...
                    "to": [email],
                    "subject": "Verify your SpaceFit email",
                    "html": html_content,
                },
            )
        ...
        async with httpx.AsyncClient(timeout=10.0) as client:
            response = await client.post(
                ...
                json={
                    "from": f"{settings.resend_from_name} <{settings.resend_from_email}>",
                    "to": [email],
                    "subject": "Reset your SpaceFit password",
                    "html": html_content,
                },
            )
            if response.status_code >= 400:
