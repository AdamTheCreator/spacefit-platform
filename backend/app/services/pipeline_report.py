...
report as a dark-themed HTML email matching Space Goose branding.
"""
...
def render_report_html(data: PipelineReportData) -> str:
    ...
    Uses Space Goose brand colors (dark background, teal accents) for
    consistent branding.
  ...
  <div style="max-width: 640px; margin: 0 auto; padding: 32px 16px;">
    ...
    <div style="text-align: center; padding-top: 16px; border-top: 1px solid #374151;">
      <p style="color: #4B5563; font-size: 12px; margin: 0;">
        Generated by Space Goose &mdash; Your CRE Deal Pipeline
      </p>
    </div>
